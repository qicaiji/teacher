...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            'fullscreen', 'source', 'pasteplain', '|', 'undo', 'redo', '|',
            'forecolor', 'backcolor', 'bold', 'italic', 'underline', '|', //'fontborder', 
			'insertorderedlist', 'insertunorderedlist', '|', //'strikethrough', 
			// '|',   //'selectall', 'cleardoc', '|',
        ...
        ,initialFrameWidth: '100%'  //初始化编辑器宽度,默认1000,让编辑器自适应宽度
